...
import com.wgu.gigacamp.EditCampsiteActivity;
...
public class Adapter_MyCampsite extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
     ...
     */
    public Adapter_MyCampsite(Context campsiteContext, List<Campsite> campsiteList, Account userAccount){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Adapter_MyCampsite.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        Adapter_MyCampsite.ViewHolder viewHolder = (Adapter_MyCampsite.ViewHolder) holder;
        ...
        viewHolder.campsiteListItemResButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(campsiteContext, EditCampsiteActivity.class);
