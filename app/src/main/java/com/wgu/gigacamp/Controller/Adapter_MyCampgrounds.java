...
import com.wgu.gigacamp.DetailsMyCampgroundActivity;
...
public class Adapter_MyCampgrounds extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public Adapter_MyCampgrounds(Context campgroundContext, List<Campground> campgroundsList, Account userAccount){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.campgroundView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(campgroundContext, DetailsMyCampgroundActivity.class);
